...
compute_rhino3d.Util.url = "http://lisipe.modelical.com/"
compute_rhino3d.Util.apiKey = "Speckle01Compute"


#create geometry with rihno3dm
...
output = gh.EvaluateDefinition(r"C:\Users\david\Desktop\intro-compute-main\python\compute\SampleGhBasic\twisty.gh", trees)
